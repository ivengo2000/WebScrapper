...
{
    public partial class PrayersForm : Form
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            var myDevotionals = _mediaPagesService.GetPrayersLight(mediaPageFilterModel);
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(url) && !string.IsNullOrEmpty(title) && !string.IsNullOrEmpty(path) && !string.IsNullOrEmpty(id))
            {
                ...
                {
                    MdiParent = this.MdiParent, PageId = id, Text = $@"{Consts.Articles.Prayer} .:. {path}"
                };
        ...
        private void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            var prayers = _mediaPagesService.GetPrayers(mediaPageFilterModel);

            if (prayers != null && prayers.Any())
            {
                saveFileDialogExportToExcel.FileName = _mediaPagesService.GetInitialExcelFileName(mediaPageFilterModel, Consts.ExportFilePrefixes.Prayer);
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    DataUtilities.ExportToExcel(prayers, fileName);
                }
            }
        }
