...
{
    public partial class MyDevotionalsForm : Form
    {
        private readonly MediaPagesService _mediaPagesService;

        public MyDevotionalsForm()
        {
            InitializeComponent();
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            var myDevotionals = _mediaPagesService.GetMyDevotionalsLight(mediaPageFilterModel);
        ...
        private void MyDevotionalsForm_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(url) && !string.IsNullOrEmpty(title) && !string.IsNullOrEmpty(path) && !string.IsNullOrEmpty(id))
            {
                ...
                {
                    MdiParent = this.MdiParent, PageId = id, Text = $@"{Consts.Articles.MyDevotional} .:. {path}"
                };
        ...
        private void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            var myDevotionals = _mediaPagesService.GetMyDevotionals(mediaPageFilterModel);

            if (myDevotionals != null && myDevotionals.Any())
            {
                saveFileDialogExportToExcel.FileName = _mediaPagesService.GetInitialExcelFileName(mediaPageFilterModel, Consts.ExportFilePrefixes.MyDevotional);
